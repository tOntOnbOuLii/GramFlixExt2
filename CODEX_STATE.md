...
- Synopsis 1JOUR1FILM ajoutés (scraping + fallback WordPress) pour alimenter les fiches Cloudstream.
- Accueil Cloudstream nourri via l’API WordPress (populaires, derniers films/séries/saisons/épisodes).
...
- Paquet(s) `gramflix-all.cs3` et `gramflix-1jour1film.cs3` regenere(s) pour GramFlix v1.4.6 (plugin version 11, 63971 octets).
...
- Release GitHub GramFlix v1.4.6 à publier (artefacts `gramflix-all.cs3` / `gramflix-1jour1film.cs3`, plugin 11).
